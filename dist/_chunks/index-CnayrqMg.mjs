...
const index = {
  register(app) {
    app.createSettingSection(
      ...
      [
        // links
        {
          ...
          Component: () => import("./Settings-CU0ZEuXD.mjs"),
          permissions: [
    ...
    app.customFields.register({
      ...
      icon: PluginIcon,
      components: {
        Input: () => import("./index-B4gGs6DE.mjs")
      },
      options: {
        advanced: [
          {
  ...
  async registerTrads({ locales }) {
    return Promise.all(
      locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-BkYaS1vA.mjs") }), `./translations/${locale}.json`, 3);
          return { data, locale };
        } catch {
          return { data: {}, locale };
        }
